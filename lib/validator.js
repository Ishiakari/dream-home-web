...
/**
 * 🔒 Authentication Validation Rules (Frontend)
 */
export const signupValidators = {
    firstName:    { required: true, maxLength: 100, label: 'First Name', pattern: REGEX.NAME, patternMessage: "Only letters, spaces, hyphens, and apostrophes allowed" },
    lastName:     { required: true, maxLength: 100, label: 'Last Name', pattern: REGEX.NAME, patternMessage: "Only letters, spaces, hyphens, and apostrophes allowed" },
    email:        { required: true, maxLength: 255, label: 'Email', pattern: REGEX.EMAIL, patternMessage: 'Enter a valid email address' },
    telephoneNo:  { required: true, maxLength: 50, label: 'Telephone Number', pattern: REGEX.PH_PHONE_FAX, patternMessage: 'Enter a valid PH phone number (e.g. 0912-345-6789)' },
    address:      { required: true, maxLength: 255, label: 'Address', pattern: REGEX.ADDRESS, patternMessage: 'Invalid characters in address' },
    password:     { required: true, label: 'Password', pattern: REGEX.PASSWORD, patternMessage: 'Password must be at least 8 chars, with 1 letter and 1 number' }
};

export const loginValidators = {
    email:        { required: true, label: 'Email', pattern: REGEX.EMAIL, patternMessage: 'Enter a valid email address' },
